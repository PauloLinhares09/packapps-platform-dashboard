...
<div id="main-content">
        ...
        <section id="left-section">
            ...
            <!-- Code reapeted from new_assistent.php -->
            <form id="custom-form">
        ...
        <!-- END Code reapeted from new_assistent.php -->
        ...
        <section id="right-section">
            ...
            <div class="chat-message">
                <span class="user-name">Usuário 1:</span>
                <p class="message">Olá, como vai?</p>
            </div>
            <div class="chat-message">
                <span class="user-name">Usuário 2:</span>
                <p class="message">Tudo bem, e você?</p>
            </div>
            <!-- Adicione mais mensagens conforme necessário -->
            </div>
            <div id="chat-input">
                <textarea type="text" id="user-message" rows="5" placeholder="Digite sua mensagem aqui..."></textarea>    
